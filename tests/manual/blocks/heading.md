...
```html
<h2 data-pb-block="heading" data-pb-tag="level" data-pb-text="text">Chapter one: the editor</h2>
<h3 data-pb-block="heading" data-pb-tag="level" data-pb-text="text">A quieter subsection</h3>
