...
- [ ] Linked sides write the shorthand; unlinking exposes four independent side values.
- [ ] Ordered dimension and gap tokens use a discrete slider; custom CSS is behind Custom value.
