...
Gutenberg semantics on pick: replace an empty paragraph, insert after a
...
- [ ] The panel stays open after a pick (Gutenberg keeps it up); Escape / the ✕ closes it and focus returns to the + button.
