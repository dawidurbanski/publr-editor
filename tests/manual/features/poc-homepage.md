...
- [ ] Decorative SVGs are selectable as raw-html blocks (opaque, lossless).
  ...
  <div data-pb-block="group" data-pb-tag="tag" data-pb-children class="bg-gray-900">
    <main data-pb-block="group" data-pb-tag="tag" data-pb-children>
      ...
      <div
        ...
        data-pb-tag="tag"
        data-pb-children
        class="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8"
      >
        <h2
          data-pb-block="heading"
          data-pb-tag="level"
      ...
      <div data-pb-block="group" data-pb-tag="tag" data-pb-children class="mt-32 sm:mt-56">
        <div
          data-pb-block="group"
          data-pb-tag="tag"
          data-pb-children
      ...
      <div
        ...
        data-pb-tag="tag"
        data-pb-children
        class="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8"
      >
        <svg
          aria-hidden="true"
          class="absolute inset-0 -z-10 size-full mask-[radial-gradient(100%_100%_at_top_right,white,transparent)] stroke-white/10"
