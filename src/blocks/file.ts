// File block — a link to a downloadable file (Gutenberg core/file): main
...
//
// Dropped GB attributes (core/file): id/blob (media library), fileId
...
export const definition: BlockDefinition = {
  ...
  settings: [
    { control: "text", label: "File URL", field: "href", placeholder: "https://…/file.pdf" },
    {
      control: "toggle",
  ...
  render(fields: Fields, settings?: Settings) {
    ...
    return (
      ...
      `<a data-pb-rich="name" data-pb-link="href" href="${href}" class="min-w-0 font-semibold [overflow-wrap:anywhere] text-inherit no-underline">${str(fields.name)}</a>` +
