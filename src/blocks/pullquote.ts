...
export const definition: BlockDefinition = {
  ...
  render(fields: Fields) {
    return `<figure data-pb-block="pullquote" class="border-y py-6 text-center"><blockquote class="text-2xl"><div data-pb-rich="value">${str(fields.value)}</div></blockquote><cite data-pb-text="citation" class="mt-2 block text-sm not-italic">${escHtml(fields.citation ?? "")}</cite></figure>`;
  },
};
